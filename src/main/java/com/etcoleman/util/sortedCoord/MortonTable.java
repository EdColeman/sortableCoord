...
public class MortonTable {
    ...
    private static final int mortonTable[] = {0x0000, 0x0001, 0x0004, 0x0005,
    ...
    private static final byte decodeTable[] = {0x00, 0x01, 0x00, 0x01, 0x02, 0x03,
    ...
    public static long mortonTable(final int odd, final int even) {
        ...
        return ((msw << 32) & 0xffffffff00000000l)
    ...
    public static int mortonTable16(final int odd, final int even) {
        ...
        return mortonTable[(odd >> 8) & 0xff] << 17
