...
public class SortedCoord {
	...
	private static double scale = Integer.MAX_VALUE;
	 ...
	 * 
	 * @param latitude
	 *            decimal latitude value between (-90 and 90) exclusive.
	 * @param longitude
	 *            decimal longitude value between (-180 and 180) exclusive.
	 * 
	 ...
	 * converted into a string that is lexigraphically sortable.
	 * 
	 * @param value
	 * @return
	 */
	 ...
	 * 
	 * @param maxRange
	 *            either 90 for latitude or 180 for longitude.
	 * 
	 ...
	 * 
	 * @param interleaved
	 *            a 64 bit value of longitude, latitude with msb longitude bit
